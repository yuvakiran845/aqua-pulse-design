      ...
      <div className="relative z-20 container-main text-center pt-16 pb-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button variant="aqua" size="lg" className="w-[80%] max-w-[240px] sm:w-auto sm:min-w-[200px] font-bold text-base shadow-[0_0_20px_rgba(34,211,238,0.3)]" asChild>
              <a href="#enquiry">Register Now</a>
            </Button>
            <Button variant="whatsapp" size="lg" className="w-[80%] max-w-[240px] sm:w-auto sm:min-w-[200px] font-bold text-base" asChild>
